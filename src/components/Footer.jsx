        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <div className="social-links">
              ...
              <a href="mailto:abubakr.bgnu@gmail.com" aria-label="Gmail" className="gm"><i className="fas fa-envelope"></i></a>
              <a href="https://wa.me/923097354874" aria-label="WhatsApp" target="_blank" rel="noreferrer" className="wa"><i className="fab fa-whatsapp"></i></a>
            </div>
          </div>
